...
/**
 Base class for all FreezeAlarm views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the FreezeAlarm view hierarchy (such as wrapped iOS UIViews) was touched.
