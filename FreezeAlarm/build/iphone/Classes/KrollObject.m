 ...
 * Copyright (c) 2009-2011 by FreezeAlarm, Inc. All Rights Reserved.
...
//@interface FreezeAlarmObject : NSObject
//@end

@interface FreezeAlarmObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[FreezeAlarmObject class]])
		{
			for (NSString *key in [[(FreezeAlarmObject*)o modules] allKeys])
			{
