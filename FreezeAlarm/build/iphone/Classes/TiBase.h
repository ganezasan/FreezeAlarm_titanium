...
// in simulator we redefine to format for FreezeAlarm Developer console
...
{\
	NSString * exceptionName = [@"org.freezealarm." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.freezealarm";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIFreezeAlarmNativeItemNone = -1, 
	UIFreezeAlarmNativeItemSpinner = -2,
	UIFreezeAlarmNativeItemProgressBar = -3,
	
	UIFreezeAlarmNativeItemSlider = -4,
	UIFreezeAlarmNativeItemSwitch = -5,
	UIFreezeAlarmNativeItemMultiButton = -6,
	UIFreezeAlarmNativeItemSegmented = -7,
	
	UIFreezeAlarmNativeItemTextView = -8,
	UIFreezeAlarmNativeItemTextField = -9,
	UIFreezeAlarmNativeItemSearchBar = -10,
	
	UIFreezeAlarmNativeItemPicker = -11,
	UIFreezeAlarmNativeItemDatePicker = -12,
	
	UIFreezeAlarmNativeItemInfoLight = -13,
	UIFreezeAlarmNativeItemInfoDark = -14,
	
	UIFreezeAlarmNativeItemDisclosure = -15,
	
	UIFreezeAlarmNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all FreezeAlarm instances of
