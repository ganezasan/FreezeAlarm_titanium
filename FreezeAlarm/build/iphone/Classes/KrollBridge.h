...
@interface FreezeAlarmObject : KrollCoverageObject {
#else
@interface FreezeAlarmObject : KrollObject {
#endif
@private
...
extern NSString * FreezeAlarm$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	FreezeAlarmObject *_freezealarm;
    KrollObject* console;
	BOOL shutdown;
